...
HRESULT CD3DApplication::Create( HINSTANCE hInstance )
{
    ...
    g_pD3D = m_pD3D = Direct3DCreate9( D3D_SDK_VERSION );
    if( m_pD3D == NULL )
...
HRESULT CD3DApplication::BuildDeviceList()
{
    ...
    for( UINT iAdapter = 0; iAdapter < m_pD3D->GetAdapterCount(); iAdapter++ )
    {
        ...
        DWORD dwNumModes        = 0;
        DWORD dwNumAdapterModes = m_pD3D->GetAdapterModeCount( iAdapter, D3DFMT_A8R8G8B8 );
        ...
        for( UINT iMode = 0; iMode < dwNumAdapterModes; iMode++ )
        {
            ...
            m_pD3D->EnumAdapterModes( iAdapter, D3DFMT_A8R8G8B8, iMode, &DisplayMode );

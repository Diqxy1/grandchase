...
public:
	...
	int FindStringExact(int nStartAfter, LPCTSTR lpszString);     // Jaeho.Add

	int SelectString(int nStartAfter, LPCTSTR lpszString);
	void ShowDropDown(BOOL bShowIt = TRUE);
	void ResetContent();
	int GetCurSel();
	int SetCurSel(int iSel);   // Jaeho.Add
	int GetCount(void);         // Jaeho.Add
	int InsertString(int index, LPCTSTR lpszString);   // Jaeho.Add
	// Attribute
public:
	void Init();

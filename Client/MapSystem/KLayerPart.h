...
public:
    ...
    const KSafeArray<SLVERTEX,4>&     GetRenderVertex() const
    {
...
protected:
    ...
    // uv, Vertex
    KSafeArray<SLVERTEX,4> m_Vertex;
    KSafeArray<float,4> m_fUV;
    ...
    // CameraMovingRadio : 카메라가 움직임에 따라 배경도 따라 움직인다.
    float               m_fCMRadioX;
    float               m_fCMRadioY;
    ...
    KSafeArray<SLVERTEX,4> ScrolledVertex;
    float               m_fZoffset;
...
public:
	...
	virtual void SetScroll_X( bool bScroll ) { m_bScroolX = bScroll; }
	virtual bool GetScroll_X() { return m_bScroolX; }
	virtual void SetScroll_Y( bool bScroll ) { m_bScroolY = bScroll; }
	virtual bool GetScroll_Y() { return m_bScroolY; }

    virtual void SetCMRadio_X( float fCMRadioX ) { m_fCMRadioX = fCMRadioX; }
    virtual float GetCMRadio_X() { return m_fCMRadioX; }
    virtual void SetCMRadio_Y( float fCMRadioY ) { m_fCMRadioY = fCMRadioY; }
    virtual float GetCMRadio_Y() { return m_fCMRadioY; }

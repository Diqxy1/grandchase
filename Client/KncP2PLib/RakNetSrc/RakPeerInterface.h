...
public:
	...
	virtual void Disconnect( unsigned long blockDuration, unsigned long userData = 0x00000000 ) = 0;
	/**
	...
	virtual void CloseConnection( PlayerID target, bool sendDisconnectionNotification, unsigned long blockDuration, unsigned long userData = 0x00000000 ) = 0;
	/**

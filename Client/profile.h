...
#define PROFILE_SET(a)                  PROFILE_BEGIN(a);\
                                        BOOST_SCOPE_EXIT((&g_bProfile)(&g_profile_1)) \
                                        { \
                                            PROFILE_END(a); \
                                        }BOOST_SCOPE_EXIT_END;

#define PROFILE_SET2(a)                 PROFILE_BEGIN2(a);\
                                        BOOST_SCOPE_EXIT((&g_bProfile)(&g_profile_2)) \
                                        { \
                                            PROFILE_END2(a); \
                                        }BOOST_SCOPE_EXIT_END;
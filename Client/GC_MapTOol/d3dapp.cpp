...
EndWindowedDeviceComboSearch:
	...
	m_d3dSettings.Windowed_VertexProcessingType = HARDWARE_VP;//*(VertexProcessingType*)pBestDeviceCombo->pVertexProcessingTypeList->GetPtr(0);
...
HRESULT CD3DApplication::Initialize3DEnvironment()
{
	...
	UINT AdapterToUse = m_d3dSettings.AdapterOrdinal();
	D3DDEVTYPE DeviceType = pDeviceInfo->DevType;

#define _NVPERF_TOOL_
#ifdef _NVPERF_TOOL_
#ifdef _DEBUG
...
void CD3DApplication::BuildPresentParamsFromSettings()
{
	...
	// m_d3dpp.Flags |= D3DPRESENTFLAG_LOCKABLE_BACKBUFFER;  // Dialog 보여주기...

...
#include ".\HardDamageShotMagicCircle.h"
...
CHardDamageShotMagicCircle::CHardDamageShotMagicCircle(void)
{
    m_iCrashCount = 5;
...
void CHardDamageShotMagicCircle::FrameMove( CDamageInstance* pDamageInstance )
{
...
void CHardDamageShotMagicCircle::Begin( CDamageInstance* pDamageInstance )
{

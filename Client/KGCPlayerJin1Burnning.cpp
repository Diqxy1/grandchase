...
KGCPlayerJin1Burnning::KGCPlayerJin1Burnning()
{
...
int KGCPlayerJin1Burnning::OnRun(PLAYER* pPlayer, bool bKeyProc)
{
	if(bKeyProc)
	{
...
int KGCPlayerJin1Burnning::OnDash(PLAYER* pPlayer, bool bKeyProc)
{
	if(bKeyProc)
	{
		if( g_MyD3D->MyCtrl->k_Up )

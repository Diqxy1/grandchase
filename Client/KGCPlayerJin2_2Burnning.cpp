...
KGCPlayerJin2_2Burnning::KGCPlayerJin2_2Burnning()
{
...
int KGCPlayerJin2_2Burnning::OnRun(PLAYER* pPlayer, bool bKeyProc)
{
	if(bKeyProc)
	{
...
int KGCPlayerJin2_2Burnning::OnDash(PLAYER* pPlayer, bool bKeyProc)
{
	if(bKeyProc)
	{
		if( g_MyD3D->MyCtrl->k_Up )

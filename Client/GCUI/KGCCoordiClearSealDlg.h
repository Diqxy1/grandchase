...
class KGCCoordiClearSealDlg :  public KD3DDialog,
									   public KActionListener
{
public:
	DECLARE_CLASSNAME( KGCCoordiClearSealDlg );
	KGCCoordiClearSealDlg(void);
	virtual ~KGCCoordiClearSealDlg(void);

	KGCCoordiClearSealDlg( const KGCCoordiClearSealDlg& )
	{ ASSERT( false && "Do not use copy constructor!" ); }
	/// Assignment operator
	const KGCCoordiClearSealDlg& operator=( const KGCCoordiClearSealDlg& )
...
DEFINE_WND_FACTORY( KGCCoordiClearSealDlg );
DECLARE_WND_FACTORY( KGCCoordiClearSealDlg );
DECLARE_WND_FACTORY_NAME( KGCCoordiClearSealDlg );

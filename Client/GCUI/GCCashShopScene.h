#ifndef _GCCASHSHOPSCENE_H_
#define _GCCASHSHOPSCENE_H_
...
class KGCCashShopScene : public KGCScene // extends
{
public:
    DECLARE_CLASSNAME(KGCCashShopScene);
    /// Default constructor
    KGCCashShopScene(void);
    /// Default destructor
    virtual ~KGCCashShopScene(void);
    /// Copy constructor
    KGCCashShopScene(const KGCCashShopScene&)
    {
        ASSERT(false && "Do not use copy constructor!");
    }
    /// Assignment operator
    const KGCCashShopScene& operator=(const KGCCashShopScene&)
    {
...
protected:
    ...
    KD3DWnd* m_pkAccessoryTabLeftRound;
    KD3DWnd* m_pkAccessoryTabBothRound;
    KD3DWnd* m_pkArmorTabDummy;
public:
...
DEFINE_WND_FACTORY(KGCCashShopScene);
DECLARE_WND_FACTORY(KGCCashShopScene);
DECLARE_WND_FACTORY_NAME(KGCCashShopScene);

#endif // _GCCASHSHOPSCENE_H_

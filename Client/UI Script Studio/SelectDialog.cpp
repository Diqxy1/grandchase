...
void CSelectDialog::OnInitDone()
{
	...
	pFD->GetDlgItem(stc3)->SetWindowPos(0,rectCancel.left - 430,rectCancel.top + 5, rectStatic.Width(), rectStatic.Height(), SWP_NOZORDER);

	//CRect rectEdit1;pFD->GetDlgItem(edt1)->GetWindowRect(&rectEdit1);
	//pFD->ScreenToClient(&rectEdit1);
	//pFD->GetDlgItem(edt1)->SetWindowPos(0,rectCancel.left - 360,rectCancel.top, rectEdit1.Width() - 25, rectEdit1.Height(), SWP_NOZORDER);

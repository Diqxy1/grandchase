...
namespace lua_tinker
{
	...
	// define Functor count
#define LUA_TINKER_FUNCTOR_ARG 8

// functor
#include "lua_tinker_invoke.h"

// push_functor
#include "lua_tinker_push_functor.h"
...
// member variable
	...
	// member function
#include "lua_tinker_member_functor.h"

// push_functor
#include "lua_tinker_push_member_functor.h"
...
// constructor
	...
	void class_add(lua_State * L, const char* name)
	{
		...
		lua_getfield(L, LUA_GLOBALSINDEX, "__bind");
		if (lua_isnil(L, -1)) {
			lua_pop(L, 1);

                           ...
                           FLOAT a )
{
	...
	//mtrl.Emissive.r = mtrl.Emissive.g = mtrl.Emissive.b = mtrl.Emissive.a = .5f;
	//mtrl.Specular.r = mtrl.Specular.g = mtrl.Specular.b = mtrl.Specular.a = mtrl.Power=1.5f;
...
HRESULT D3DUtil_CreateTexture( LPDIRECT3DDEVICE9 pd3dDevice, TCHAR* strTexture,
                               LPDIRECT3DTEXTURE9* ppTexture, D3DFORMAT d3dFormat, bool MipMap )
{
                                              ...
                                              FLOAT fTrackBallRadius )
{
    ...
    FLOAT d1 = 0.0f;
    FLOAT d2 = ASMsqrt( sx*sx + sy*sy );

    if( d2 < fTrackBallRadius * 0.70710678118654752440 ) // Inside sphere
        sz = ASMsqrt( fTrackBallRadius*fTrackBallRadius - d2*d2 );
    else                                                 // On hyperbola

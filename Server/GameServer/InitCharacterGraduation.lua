...
ScriptUpdatePlan =
{
    ---[[
    {
        CheckTime   = { 2013, 05, 28, 00, 00 }, -- YYYY, MM, DD, HH, mm ( mm은 설정 하지마세요. 00 고정)
        ScriptInfo   = {
    ...
    --[[
	{
        CheckTime   = { 2013, 04, 02, 05, 00 }, -- YYYY, MM, DD, HH, mm ( mm은 설정 하지마세요. 00 고정)
        ScriptInfo   = {
	...
	{
        CheckTime   = { 2013, 04, 03, 05, 00 }, -- YYYY, MM, DD, HH, mm ( mm은 설정 하지마세요. 00 고정)
        ScriptInfo   = {

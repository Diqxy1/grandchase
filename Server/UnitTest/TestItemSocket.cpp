...
void TestItemSocket()
{
...

    {
        ...
        //KEVENT_SOCKET_OPEN_REQ kSocketOpenReq;
        //kSocketOpenReq.m_ItemUID = 423317; // 캐슬킹 투구
        //kSocketOpenReq.m_CashItemID = 287060;
        //kSocketOpenReq.m_kSocketInfo.m_cSlotID = 1;

        //pkUserProxy->SendPacket( KUserEvent::EVENT_SOCKET_OPEN_REQ, kSocketOpenReq );

        //KEVENT_MONSTER_CARD_INSERT_REQ kInsertReq;

        //kInsertReq.m_ItemUID = 423317;
        //kInsertReq.m_CardItemID = 225130; // 225170, 225210, 225130 (monster cards)
        //kInsertReq.m_kSocketInfo.m_cSlotID = 1;

        //pkUserProxy->SendPacket( KUserEvent::EVENT_MONSTER_CARD_INSERT_REQ, kInsertReq );
        //Sleep(3000);


        KEVENT_MONSTER_CARD_REMOVE_REQ kRemove;
        kRemove.m_ItemUID = 423317;
        kRemove.m_CashItemID = 8880;
        kRemove.m_kSocketInfo.m_cSlotID = 1;

        pkUserProxy->SendPacket( KUserEvent::EVENT_MONSTER_CARD_REMOVE_REQ, kRemove );
        Sleep(3000);

...
public:		
    ...
    BOOL SetItemText(int nItem, int nSubItem, __int64 val);
...
protected:	
    ...
    // florist
public:
    void SetLimitText( UINT uiLimitText )       { m_uiLimitText = uiLimitText; }
    void SetMoreEditStyle( DWORD dwEditStyle )  { m_dwMoreEditStyle = dwEditStyle; }

protected:
    UINT m_uiLimitText;         // 050913. florist. 입력 가능 문자 제한수 지정.
    DWORD m_dwMoreEditStyle;    // 050913. florist. edit 생성시 style을 추가할 수 있도록 함.
};
